...
class NotificationRepositoryImpl(
    ...
    override suspend fun addDeviceTokenToNotification(deviceToken: String): ResponseWrapper<Nothing> {
        return notificationApi.addDeviceTokenToNotification(NotificationBody(deviceToken))
    }
}