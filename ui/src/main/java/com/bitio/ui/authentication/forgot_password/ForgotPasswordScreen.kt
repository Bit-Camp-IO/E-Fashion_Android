...
import com.bitio.ui.authentication.route.navigateToVerifyEmailScreen
...
fun ForgotPasswordScreen(navController: NavController) {
    ...
    if (!authState.loading && authState.errorMessage.isEmpty()) {
        navController::navigateToVerifyEmailScreen
    }
    ...
    ForgotPasswordContent(
        ...
        onClickRecoverButton = { viewModel.onAuthEvent(AuthFormEvent.Reset) },
        ...
        Column(
            ...
            Box(
                ...
                ForgotPasswordBody(
                    ...
                    onClickRecoverButton = onClickRecoverButton
                )
            }
        }
    }
